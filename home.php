...
<header class="home-header row">
    ...
    <div class="col-6">
        <div class="geo-pattern">
            <x-graph numbers="10"></x-graph>
        </div>
    </div>
</header>
<section class="home-about">
    <div class="section-inner row">
        <div class="about-image col-4">
            <img src="<?php echo IMAGES ?>/paper-crown.jpeg" alt="ashley brandon">
        </div>
        <div class="about-text col-8">
            <h2>About</h2>
            <p>I've got over two years of commercial experience working as a web designer and developer. This includes redesigning existing pages for conversion optimisation.</p>
            <p>I work with a range of technologies. I have experience building Wordpress plugins of various kinds, and building custom functionality into Wordpress themes. I have also built several Javascript and JamStack web-apps.</p>
            <p>Some of the main technologies I use:</p>
    ...
    <div class="row">
        <div class="item-1">
            ...
            <div class="block-2">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate excepturi aperiam impedit dolor debitis harum recusandae nihil? Explicabo, velit in.</p>
                <a href="#">
